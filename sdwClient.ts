...
export interface SDW {
  ...
  login: {
     ...
     * Login
     */
    $postx(body: Body_login_login_post): Promise<unknown>;
  };
  /* Path: /config */
  config: {
    /**
  ...
  reset: {
     ...
     * Reset Iterator
     */
    $post(body: ResetBody): Promise<unknown>;
  };
  /* Path: /api */
  api: {
    /* Path: /api/{api_name} */
    "$"(api_name: string): {
       ...
       * Predict
       */
      $post(body: PredictBody): Promise<unknown>;
    };
  };
  /* Path: /run */
  run: {
  ...
  sdapi: {
    ...
    v1: {
      ...
      txt2img: {
         ...
         * Text2Imgapi
         */
        $post(body: StableDiffusionProcessingTxt2Img): Promise<TextToImageResponse>;
      };
      ...
      img2img: {
         ...
         * Img2Imgapi
         */
        $post(body: StableDiffusionProcessingImg2Img): Promise<ImageToImageResponse>;
      };
      ...
      "extra-single-image": {
         ...
         */
        $post(body: ExtrasSingleImageRequest): Promise<ExtrasSingleImageResponse>;
      };
      ...
      "extra-batch-images": {
         ...
         */
        $post(body: ExtrasBatchImagesRequest): Promise<ExtrasBatchImagesResponse>;
      };
      ...
      "png-info": {
         ...
         * Pnginfoapi
         */
        $post(body: PNGInfoRequest): Promise<PNGInfoResponse>;
      };
      ...
      interrogate: {
         ...
         * Interrogateapi
         */
        $post(body: InterrogateRequest): Promise<unknown>;
      };
      ...
      upscalers: {
         ...
         * Get Upscalers
         */
        $get(): Promise<Array<UpscalerItem>>;
      };
      ...
      hypernetworks: {
         ...
         * Get Hypernetworks
         */
        $get(): Promise<Array<HypernetworkItem>>;
      };
      ...
      "face-restorers": {
         ...
         * Get Face Restorers
         */
        $get(): Promise<Array<FaceRestorerItem>>;
      };
      ...
      "realesrgan-models": {
         ...
         */
        $get(): Promise<Array<RealesrganItem>>;
      };
      ...
      "prompt-styles": {
         ...
         * Get Promp Styles
         */
        $get(): Promise<Array<PromptStyleItem>>;
      };
