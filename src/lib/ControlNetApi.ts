...
export default class ControlNetApi {
  ...
  public async detect(
    ...
    const response = await this.sd.post<ApiRawResponse>("/controlnet/detect", {
  ...
  public async getModels(): Promise<string[]> {
    const response = await this.sd.get<{ model_list: string[] }>(
  ...
  public async getModules(): Promise<string[]> {
    const response = await this.sd.get<{ module_list: string[] }>(
